...
import com.example.wordapp.modes.Modes;
...
public class SelectGameFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		final Mode themeAnimals = Modes.Train();

		final Mode themeMonsters = Modes.oneVSone();
		final Mode themeEmoji = Modes.Online();

		animals.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Shared.eventBus.notify(new GameSelectedEvent(themeAnimals));
			}
		});
		...
		monsters.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Shared.eventBus.notify(new GameSelectedEvent(themeMonsters));
			}
		});
		...
		emoji.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Shared.eventBus.notify(new GameSelectedEvent(themeEmoji));
			}
		});
